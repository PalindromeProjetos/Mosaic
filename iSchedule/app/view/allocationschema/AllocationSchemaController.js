//@charset UTF-8
Ext.define( 'iSchedule.view.allocationschema.AllocationSchemaController', {
    ...
    onChangeSchemaMonthlyType: function ( field, newValue, oldValue, eOpts ) {
        ...
        view.down('schedulingperiodsearch').setReadColor(newValue.type == 1);
    ...
    onUpdateSchemaMonthly: function () {
        var me = this,
            ...
            information = 'Este planejamento será usado no processamento da escala!';
    ...
    onUpdateSchemaWeekDay: function () {
        ...
        if(store.getCount() == 0) {
            Smart.Msg.attention("Não há um MAPA selecionado para salvar no planejamento!");
            return false;
        }
    ...
    onCellClick: function ( viewTable, td, cellIndex, record, tr, rowIndex, e, eOpts ) {
        ...
        if((cellIndex == 1)&&(record.get('isselected') == true)) {
            window.open('business/Calls/allocationschemamap.php?action=select&method=getWorkSheetWeekDay&id='+record.get('id'));
        }
