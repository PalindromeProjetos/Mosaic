//@charset UTF-8
Ext.define( 'iSchedule.view.allocationschema.AllocationSchemaWeek', {
    ...
    requires: [
		...
		'iSchedule.store.allocationschema.AllocationSchemaMonthly'
    ],
    ...
    buildField: function () {
        ...
        Ext.create('iSchedule.store.allocationschema.AllocationSchemaMonthly');
