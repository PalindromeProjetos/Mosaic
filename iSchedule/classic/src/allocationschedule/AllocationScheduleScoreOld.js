//@charset UTF-8
Ext.define( 'iSchedule.view.allocationschedule.AllocationScheduleScoreOld', {
                        ...
                        items: [
                            {
                                ...
                                store: Ext.create('iSchedule.store.allocationschedule.SchedulingMonthlyScore'),
                                columns: [
                                    {
                                        text: 'Plantonista',
