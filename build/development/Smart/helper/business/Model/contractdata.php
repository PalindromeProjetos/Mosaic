...
/**
 * 
 * @Entity {"name":"contractdata", "cache":"\\iContract\\Cache\\contractdata", "event":"\\iContract\\Event\\contractdata"}
 */
class contractdata extends \Smart\Data\Model {
    ...
    /**
     * @Policy {"nullable":false, "default":"", "length":16777215}
     * @Column {"description":"", "type":"string", "policy":true}
     */
    private $observation;
    ...
    /**
     * @param type $id
     * @return \iContract\Model\contractdata
     */
